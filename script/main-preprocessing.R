...
df_sf_idn <- readRDS('data/map-idn.rds')  # df_sf_idn <- st_read('data/38.shp')
...
interaction <- c(
  ...
  '12' = 'State Forces Vs Rebels', '13' = 'State Forces Vs Political Militias',
  '14' = 'State Forces Vs Identity Militias', '15' = 'State Forces Vs Rioters',
  ...
  '24' = 'Rebels Vs Identity Militias', '25' = 'Rebels Vs Rioters',
  '26' = 'Rebels Vs Protesters', '27' = 'Rebels Vs Civilians',
  '28' = 'Rebels Vs Others', '30' = 'Sole Political Militias Action',
  '33' = 'Political Militias Vs Political Militias',
  '34' = 'Political Militias Vs Identity Militias',
  '35' = 'Political Militias Vs Rioters', '36' = 'Political Militias Vs Protesters',
  '37' = 'Political Militias Vs Civilians', '38' = 'Political Militias Vs Others',
  '40' = 'Sole Identity Militias Action', '44' = 'Identity Militias Vs Identity Militias',
  '45' = 'Identity Militias Vs Rioters', '46' = 'Identity Militias Vs Protesters',
  '47' = 'Identity Militias Vs Civilians', '48' = 'Identity Militias Vs Other',
